...
Assert-Contains $assemblyInfo 'AssemblyVersion("0.1.4")' "Assembly version must follow the StaxRip2 release line."
Assert-Contains $assemblyInfo 'AssemblyFileVersion("0.1.4")' "File version must follow the StaxRip2 release line."
...
Assert-Contains $updateChecker 'Dim assetPlatform = If(x64, "x64", "x86")' "Update checks must select release assets for the current process architecture."
...
Assert-Contains $buildDocs "StaxRip2-v0.1.4-x64.7z" "Build docs must document the v0.1.4 release archive name."
...
Assert-Contains $releaseNotes "# StaxRip2 v0.1.4" "Release notes must identify the v0.1.4 release."
Assert-Contains $releaseNotes "StaxRip2-v0.1.4-x64.7z" "Release notes must document the full package asset."

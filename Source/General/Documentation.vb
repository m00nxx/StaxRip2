...
Public Class Documentation
    ...
    Shared Function GetMacros() As String
        ...
        sb.AppendLine("- `<trim(<input>)>`")
        sb.AppendLine("  - **\<input\>** is any text you want to have all leading and trailing white-space characters removed")
        sb.AppendLine("  - Examples:")
        sb.AppendLine("    - `<trim(  StaxRip is cool )>` => `Staxrip is cool`")

...
Assert-Contains $assemblyInfo 'AssemblyVersion("0.1.2")' "Assembly version must follow the StaxRip2 release line."
Assert-Contains $assemblyInfo 'AssemblyFileVersion("0.1.2")' "File version must follow the StaxRip2 release line."
...
Assert-Contains $buildDocs "StaxRip2-v0.1.2-x64.7z" "Build docs must document the v0.1.2 release archive name."
...
Assert-Contains $releaseNotes "# StaxRip2 v0.1.2" "Release notes must identify the v0.1.2 release."
Assert-Contains $releaseNotes "StaxRip2-v0.1.2-x64.7z" "Release notes must document the full package asset."

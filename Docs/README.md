...
> [!NOTE]
> This documentation is inherited from upstream StaxRip and is being audited for StaxRip2.
...
> [!TIP]
> StaxRip2 does not currently publish project-specific donation links. Use the official upstream project pages for upstream StaxRip support.

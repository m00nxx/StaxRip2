...
#End Region
            ...
            For Each pref In preferences
                ...
                For Each extension In extensions
                    ...
                    If extension = p.SourceFile.Ext OrElse extension = "*" Then
                        ...
                        If Not formatMatches Then Continue For

                        Dim matchedFilter = sourceFilters.FirstOrDefault(Function(cat) cat.Name = pref.Value)

                        If matchedFilter IsNot Nothing Then
                            p.Script.SetFilter("Source", matchedFilter.Name, matchedFilter.Script)
                            Exit Sub
                        End If
                    End If
                Next
    ...
    Shared Function GetDefaultMainMenu() As CustomMenuItem
        ...
        ret.Add("File|-")
        ret.Add("File|Open Project...", NameOf(ShowFileBrowserToOpenProject), Symbol.OpenFile)
        ...
        ret.Add("File|-")
        ret.Add("File|Exit", NameOf([Exit]), Keys.X Or Keys.Alt, Symbol.fa_window_close)

        ret.Add("Crop", NameOf(ShowCropDialog), Keys.F3, Symbol.fa_crop)
        ...
        ret.Add("Help|-")
        ret.Add("Help|Website", NameOf(g.DefaultCommands.ExecuteCommandLine), Symbol.fa_github, {"https://github.com/m00nxx/StaxRip2"})
        ret.Add("Help|Documentation", NameOf(g.DefaultCommands.ExecuteCommandLine), Keys.F1, Symbol.fa_book, {"https://github.com/m00nxx/StaxRip2/tree/master/Docs/README.md"})
        ret.Add("Help|Changelog", NameOf(g.DefaultCommands.ExecuteCommandLine), Symbol.Bookmarks, {"https://github.com/m00nxx/StaxRip2/blob/master/CHANGELOG.md"})
        ret.Add("Help|Support", NameOf(g.DefaultCommands.ExecuteCommandLine), Symbol.Heart, {"https://github.com/m00nxx/StaxRip2?tab=readme-ov-file#contribution--support"})
        ret.Add("Help|-")
        ret.Add("Help|Report an issue", NameOf(g.DefaultCommands.ExecuteCommandLine), Symbol.fa_bug, {"https://github.com/m00nxx/StaxRip2/issues/new/choose"})
        ret.Add("Help|-")

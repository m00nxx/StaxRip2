...
Assert-Contains $assemblyInfo 'AssemblyVersion("0.1.6")' "Assembly version must follow the StaxRip2 release line."
Assert-Contains $assemblyInfo 'AssemblyFileVersion("0.1.6")' "File version must follow the StaxRip2 release line."
...
Assert-Contains $buildDocs "StaxRip2-v0.1.6-x64.7z" "Build docs must document the v0.1.6 release archive name."
...
Assert-Contains $releaseNotes "# StaxRip2 v0.1.6" "Release notes must identify the v0.1.6 release."
Assert-Contains $releaseNotes "StaxRip2-v0.1.6-x64.7z" "Release notes must document the full package asset."
